@extends('layouts.app')
@section('title', 'Thống kê xe ' . $vehicle->plate_number . ' - Năm ' . $year)
    ...
    <div class="row align-items-center g-2">
        <div class="col">
            <h4 class="mb-0 fw-bold">
                <i class="bi bi-truck-front"></i> {{ $vehicle->plate_number }}
...
<div class="row g-3 mb-4">
    ...
    <div class="col-12 col-md-6">
        <div class="card border-0 shadow-sm text-center" style="background: linear-gradient(45deg, #198754, #20c997);">
            <div class="card-body py-3">
                <div class="text-white text-opacity-75 small mb-1">Doanh thu cả năm</div>
                <div class="fw-bold fs-3 text-white">{{ number_format($yearTotal['total_amount'], 0, ',', '.') }}đ</div>
            </div>
        </div>
    </div>
</div>
...
<div class="card shadow-sm">
    <div class="card-header">
        <h6 class="mb-0 fw-semibold"><i class="bi bi-table"></i> Hoạt động theo tháng</h6>
    </div>
    <div class="card-body p-0">
        @forelse($months as $row)
        <a href="{{ route('vehicle-stats.by-month', [$vehicle, $year, $row->month]) }}" class="text-decoration-none text-reset">
                ...
                <div class="col">
                    <div class="row g-2">
                        ...
                        <div class="col-5">
                            ...
                            <div class="fw-bold text-success">{{ number_format($row->total_amount, 0, ',', '.') }}đ</div>
                        </div>
        ...
        <div class="row align-items-center g-0 px-3 py-3 bg-light fw-bold">
            ...
            <div class="col">
                <div class="row g-2">
                    ...
                    <div class="col-6">
                        <div class="text-muted small">Doanh thu</div>
                        <div class="fw-bold text-success fs-5">{{ number_format($yearTotal['total_amount'], 0, ',', '.') }}đ</div>
                    </div>
                </div>
            </div>
        </div>
