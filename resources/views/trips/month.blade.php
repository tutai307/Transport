            ...
            @foreach($days as $d)
                       ...
                       class="text-decoration-none">
                        <div class="card border-primary h-100 day-card day-card-active">
                            <div class="card-body p-2 text-center">
                                <div class="fw-bold text-primary" style="font-size: 18px;">{{ $d['day'] }}</div>
                                @if($hasTrips)
                ...
                @else
                    <div class="card border-light h-100 day-card day-card-empty">
                        <div class="card-body p-2 text-center">
                            <div class="text-muted" style="font-size: 18px;">{{ $d['day'] }}</div>
...
<style>
    ...
    @media (max-width: 767px) {
        .d-grid[style*="repeat(7"] { grid-template-columns: repeat(7, 1fr) !important; gap: 4px !important; }
        .day-card { min-height: 64px; }
        .day-card .card-body { padding: 4px !important; }
        .day-card .fw-bold { font-size: 13px !important; }
        .day-card .small { font-size: 10px !important; }
    }
</style>
@endpush
@endsection
